...
import asyncio
import json
from schemas import StorageWithFoodInfo
...
async def generate_recipe(ingredients: list[StorageWithFoodInfo], num_servings: int, uses_storages_only: bool, comment: str):
    prompt_message = f"""
